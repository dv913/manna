/*
*Tree vs while -- tested for convergence of distribtuion 
*based on rand num classification using tree vs while.
*The first  part of the code is a parser or a dist.in file into 
*an int array used to generate the tree.
*
*Some TESTS for classification of a rand num
*using tree vs while are also implemented in 
*tree_test_num_class.c
*
*As of Nov 18 2015
*/
...
#define MODE 1 // 1for tree, 0for while
